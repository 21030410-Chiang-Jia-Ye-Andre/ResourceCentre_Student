...
public class ResourceCentreTest {
	...
	public void testAddChromebook() {
		...
		//Given an empty list, after adding an item, the size of the list is 1.
		ResourceCentre.addChromebook(chromebookList, cb1);
		assertEquals("Test if that Chromebook arraylist size is 1?", 1, chromebookList.size());
		
		//The item added is just as same as the first item of the list.
	...
	public void testRetrieveAllCamcorder() {
		...
		//test if the expected output string same as the list of camcorders retrieved from the Resource Centre
	...
	public void testRetrieveAllChromebook() {
		...
		//Given an empty list, after adding 2 item, test if the size of the list is 2 - normal
		ResourceCentre.addChromebook(chromebookList, cb1);
		ResourceCentre.addChromebook(chromebookList, cb2);
		assertEquals("Test that chromebook arrayList size is 2?",2, chromebookList.size());
		
		
        //Test if the expected output string same as the list of chromebooks retrieve from the SourceCentre
		allChromebook= ResourceCentre.retrieveAllChromebook(chromebookList);
		testOutput = String.format("%-10s %-30s %-10s %-10s %-20s\n","CB0011", "My Google Chromebook 1st", "Yes", "", "Mac 05");
	...
	public void testDoReturnChromebook() {
		...
		//boundary
				...
				ResourceCentre.addChromebook(chromebookList, cb1);
				//error
				Boolean isReturned = ResourceCentre.doReturnChromebook(chromebookList, "CCB011");
